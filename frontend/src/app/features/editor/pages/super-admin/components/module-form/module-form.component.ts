      ...
      <div class="form-body">
        <section class="form-section">
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              [(ngModel)]="draft.name"
              placeholder="Ex: Teachers, Etudiants..."
            />
          </div>
          <div class="form-group">
        ...
        <section class="form-section">
          <div class="section-header">
            ...
            <button class="btn-add" (click)="addTableView()">
              + Ajouter une table
            </button>
          </div>
          ...
          <div class="table-views-list">
            <div
              *ngFor="let mtv of draft.tableViews; let i = index"
              class="mtv-item"
            >
              <div class="mtv-drag">⋮⋮</div>
              <div class="mtv-config">
                <select
                  [(ngModel)]="mtv.tableViewConfigId"
                  (change)="onTableViewChange(mtv)"
                >
                  <option value="">-- Sélectionner une table --</option>
                  <option
                    *ngFor="let tv of availableTableViews"
                    [value]="tv.id"
                  >
              ...
              <div class="mtv-options">
                <label class="radio-container">
                  <input
                    type="radio"
                    name="mainTv"
                    [checked]="mtv.isPrimary"
                    (change)="setMainTableView(mtv)"
                  />
