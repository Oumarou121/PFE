...
constructor(
  ...
  async switchMode(mode: "editor" | "data"): Promise<void> {
    this.mode = mode;
    if (mode === "data") {
  ...
  async renderDataContent(): Promise<void> {
    ...
    try {
      ...
      this.lookupLoading = false; this.cdr.markForCheck();
      this.dataStatusMessage = "";
    }
  }
  ...
  async reloadDataRows(): Promise<void> {
    ...
    try {
      ...
      this.dataRows = rows; this.cdr.markForCheck();
      if (
      ...
      if (requestId === this.dataRowsRequestId) {
        this.dataRowsLoading = false; this.cdr.markForCheck();
        this.dataStatusMessage = "";
      }
    }
  }
  ...
  async saveDataRow(): Promise<void> {
    ...
    try {
      ...
      this.dataSaving = false; this.cdr.markForCheck();
      this.dataStatusMessage = "";
    }
  }
    ...
    dialogRef.afterClosed().subscribe(async (confirmed) => {
      if (confirmed) {
        ...
        try {
          ...
          this.dataDeleting = false; this.cdr.markForCheck();
          this.dataStatusMessage = "";
        }
      }
    });
