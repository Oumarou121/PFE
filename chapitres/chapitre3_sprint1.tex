...
\subsection{Diagramme de séquence : La connexion sécurisée}

Le flux de connexion illustre bien la complexité cachée derrière un simple bouton \og Valider \fg{}. Le backend ne se contente pas de vérifier un mot de passe ; il doit construire un jeton JWT qui contient tout le \og pedigree \fg{} de l'utilisateur pour que les appels suivants soient performants.

\diagramplaceholder{sprint1_sequences}{Séquence d'authentification}{Processus de login et génération du périmètre utilisateur}
