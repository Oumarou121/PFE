...
Le projet est découpé en cinq sprints. Ce découpage permet de passer progressivement de l'infrastructure vers la valeur métier. Chaque sprint produit un livrable vérifiable et prépare le sprint suivant.

\subsection{Objectifs par sprint}

Le premier sprint concerne l'authentification et le socle applicatif. Le deuxième sprint met en place la gestion des rôles. Le troisième sprint développe l'édition documentaire. Le quatrième sprint ajoute l'administration des modules métier. Le cinquième sprint consolide l'intégration, les tests et la livraison.
...
La modélisation UML globale complète cette analyse en offrant une vision structurée du système. Les chapitres suivants décrivent maintenant la réalisation progressive de la plateforme à travers les cinq sprints définis.
