...
\screenshotplaceholder{sprint3/config-family1.png}{Configuration des familles documentaires}{Interface de configuration d'une famille documentaire}

\screenshotplaceholder{sprint3/config-family2.png}{Sources de données d'une famille}{Paramétrage des données utilisées par une famille documentaire}

\screenshotplaceholder{sprint3/config-family3.png}{Variables documentaires}{Préparation des variables simples et des variables tableau}
...
\screenshotplaceholder{sprint3/editor-vue.png}{Éditeur de template}{Interface principale de conception du document}

\screenshotplaceholder{sprint3/header-footer-section-editor.png}{Sections d'en-tête et de pied de page}{Configuration des zones fixes du document}

\screenshotplaceholder{sprint3/config-filter-section-editor.png}{Filtres de l'éditeur}{Paramétrage des filtres utilisés pendant la préparation du document}

L'éditeur de template permet de construire la structure du document à partir de sections modifiables. L'administrateur peut préparer le contenu, organiser l'en-tête et le pied de page, puis utiliser les filtres disponibles pour tester le modèle dans un contexte proche de l'utilisation réelle.

\screenshotplaceholder{sprint3/edit-graphic-charte.png}{Configuration de la charte graphique}{Interface de personnalisation de l'identité visuelle}

La charte graphique regroupe les éléments visuels de l'établissement, notamment le logo et les informations institutionnelles. Elle permet d'appliquer une identité cohérente aux différents modèles sans répéter la même configuration dans chaque template.

\screenshotplaceholder{sprint3/preview-document.png}{Prévisualisation du document}{Aperçu du document après fusion des données}
...
\screenshotplaceholder{sprint4/generation-select-template.png}{Sélection du modèle documentaire}{Choix du template à utiliser pour la génération}

\screenshotplaceholder{sprint4/generation-select-beneficiary.png}{Sélection du bénéficiaire}{Choix du bénéficiaire concerné par le document}

\screenshotplaceholder{sprint4/generation-preview.png}{Prévisualisation avant génération}{Aperçu du document après fusion des données}

\screenshotplaceholder{sprint4/generation-vue.png}{Génération du document}{Interface de production documentaire}
...
\screenshotplaceholder{sprint4/archive-list.png}{Liste des archives}{Consultation des documents générés}

\screenshotplaceholder{sprint4/archive-filters.png}{Filtres des archives}{Recherche des documents archivés}

\screenshotplaceholder{sprint4/archive-detail.png}{Détail d'une archive}{Informations de génération du document archivé}

\screenshotplaceholder{sprint4/archive-preview-document.png}{Aperçu d'une archive}{Consultation du rendu conservé}

\screenshotplaceholder{sprint4/archive-soft-delete.png}{Suppression logique d'une archive}{Masquage d'un document archivé avec conservation de sa trace}
