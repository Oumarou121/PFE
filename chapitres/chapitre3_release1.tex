...
\screenshotplaceholder{sprint1/home-by-role.png}{Interface d'accueil selon le rôle}{Accueil de l'utilisateur après authentification}

L'interface d'accueil oriente l'utilisateur vers les fonctionnalités qui correspondent à son rôle. Cette étape montre que l'accès n'est pas uniquement lié à la connexion, mais aussi au profil attribué.

\screenshotplaceholder{sprint1/organizations.png}{Gestion des organisations}{Interface de gestion des organisations}

La gestion des organisations permet au super administrateur de consulter et maintenir les établissements utilisant la plateforme. Elle participe directement à la mise en place du fonctionnement multi-tenant.
...
La gestion des utilisateurs et des rôles permet de contrôler les accès aux différentes parties de l'application. Elle complète le mécanisme d'authentification en associant chaque utilisateur à un profil et à un périmètre d'action.
...
\screenshotplaceholder{sprint2/config-module2.png}{Détail d'un module}{Paramétrage d'un module métier}
...
\screenshotplaceholder{sprint2/config-tableview2.png}{Configuration des colonnes}{Choix des colonnes et des libellés affichés}

\screenshotplaceholder{sprint2/config-tableview3.png}{Configuration avancée de la vue}{Paramétrage des options d'affichage de la TableView}
...
\screenshotplaceholder{sprint2/import2.png}{Résultat de l'importation}{Bilan de l'importation des données}

L'importation intelligente complète le moteur de données en facilitant l'alimentation des tables métier. Le fichier est contrôlé avant l'insertion et le résultat de l'opération permet d'identifier les données importées ainsi que les éventuelles erreurs.
