...
Le présent rapport décrit la démarche de réalisation de cette plateforme, organisée en sept chapitres :
\begin{itemize}
    ...
    \item les chapitres trois à sept décrivent la réalisation technique à travers les cinq sprints du projet, couvrant l'authentification, la gouvernance d'accès, l'édition documentaire, l'administration métier et enfin l'intégration finale.
\end{itemize}
