...
&
\textbf{ASP.NET Core 8 :} ASP.NET Core a été retenu pour le backend, car il s'intègre naturellement à une organisation en couches : contrôleurs, services, domaine et infrastructure. Cette structure a facilité l'application des principes de la Clean Architecture dans le projet.
\\
\hline
...
&
\textbf{Angular 17 :} Angular a été choisi pour construire le frontend, car il permet d'organiser l'application autour de composants, de services et de modèles TypeScript. Cette structure facilite la séparation entre l'affichage, la gestion des interactions utilisateur et les appels vers l'API, tout en gardant le code frontend plus maintenable.
\\
\hline
